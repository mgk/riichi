...
describe Riichi::Score::Pinfu do
  ...
  context "middle wait" do
    it "scores 0" do
      hand = Hand.new("p57 -- s123 p123 m678 s77")
  ...
  context "one sided end wait" do
    it "scores 0" do
      hand = Hand.new("p89 -- s123 p123 m678 s77")
      hand.draw!(Tile.to_tile("7p"))
      yaku_count(hand).must_equal(0)

      hand = Hand.new("p12 -- s123 p123 m678 s77")
      hand.draw!(Tile.to_tile("3p"))
      yaku_count(hand).must_equal(0)
    end
  end
  ...
  context "all conditions satisfied" do
    it "scores 1" do
      hand = Hand.new("p78 -- s123 p123 m678 s77")
      hand.draw!(Tile.to_tile("9p"))
